            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="relative text-base mb-5 bg-gray-200 text-gray-900 p-5 rounded-2xl">
                ...
                <p className="leading-relaxed">
                    ...
                    그러나<span className="inline-block bg-gray-900 text-white px-2 py-1 rounded-md font-bold mx-1">삼성전자 기업연계 프로젝트에 참여 </span> 하면서, 제가 작성한 코드를 직접 인수인계해야 했고, 이 과정에서 그동안 미뤄뒀던 버그와 오류들이 큰 부담이 되었습니다.<br/>
                    그 경험을 통해,<span className="inline-block bg-gray-900 text-white px-2 py-1 rounded-md font-bold mx-1"> 코드는 ‘작동만 하는 것’이 아닌 ‘다른 사람이 이해하고 유지보수할 수 있는 것’ </span>이어야 한다는 사실을 깨달았습니다.<br/>
                    이후부터는 초기 개발 단계부터 코드의 품질, 명확한 구조, 주석과 문서화, 그리고 협업을 고려한 개발을 더욱 중요하게 생각하고 있습니다.
                </p>
              </div>
